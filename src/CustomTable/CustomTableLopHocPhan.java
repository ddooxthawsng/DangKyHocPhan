 ...
 * @author User
 */
public class CustomTableLopHocPhan extends AbstractTableModel{
    private String name[]={"Mã lớp học phần","Mã học phần","Mã giảng viên","Tiết học","Thứ","Ngày bắt đầu","Địa điểm"};
    ...
    public CustomTableLopHocPhan(ArrayList<LopHocPhan> li) {
        this.li=li;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch(columnIndex){
            ...
            case 2: return li.get(rowIndex).getMaGV();
